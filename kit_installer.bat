...
SET REPO_DOWNLOAD_URL=https://github.com/kandikits/Ludo-Game-with-Sam/releases/download/v1.0/Ludo-Game.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandikits/Ludo-Game-with-Sam/raw/main/requirements.txt
SET REPO_NAME=Ludo-Game.zip
SET EXTRACTED_REPO_DIR=Ludo-Game-with-Sam
SET FILE_NAME=Ludo_game_with_Sam.py
where /q python
IF ERRORLEVEL 1 (
	ECHO==========================================================================
